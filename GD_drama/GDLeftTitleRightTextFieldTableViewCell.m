//
//  GDLeftTitleRightTextFieldTableViewCell.m
//  DeliveryProject
//
...
@interface GDLeftTitleRightTextFieldTableViewCellInnerView()
...
@implementation GDLeftTitleRightTextFieldTableViewCellInnerView
...
@interface GDLeftTitleRightTextFieldTableViewCell () <UITextFieldDelegate>

@property (nonatomic, strong) GDLeftTitleRightTextFieldTableViewCellInnerView *innerView;

@end

@implementation GDLeftTitleRightTextFieldTableViewCell
...
#pragma mark - getter && setter -
- (GDLeftTitleRightTextFieldTableViewCellInnerView *)innerView
{
    if (!_innerView) {
        _innerView = [[GDLeftTitleRightTextFieldTableViewCellInnerView alloc] init];
