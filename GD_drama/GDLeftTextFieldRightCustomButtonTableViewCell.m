//
//  GDLeftTextFieldRightCustomButtonTableViewCell.m
//  DeliveryProject
//
...
@interface GDLeftTextFieldRightCustomButtonTableViewCell () <UITextFieldDelegate>
...
@implementation GDLeftTextFieldRightCustomButtonTableViewCell
...
- (UITextField *)leftTextField
{
    if (!_leftTextField) {
        ...
        _leftTextField.textColor = [UIColor gd_blackColor];
...
- (UIView *)bottomLine
{
    if (!_bottomLine) {
        ...
        _bottomLine.backgroundColor = [UIColor gd_lightGrayColor];
    }
