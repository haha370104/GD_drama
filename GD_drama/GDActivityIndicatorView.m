...
@implementation GDActivityIndicatorView
...
{
    [self setupAnimationInLayer:self.layer withSize:self.frame.size tintColor:[UIColor gd_radicalRedColor]];
}
